...
class Settings(BaseSettings):
    ...
    smtp_from_name: str = Field(default="Fibrito", validation_alias="SMTP_FROM_NAME")
    ...
    spoonacular_rate_limit_cooldown_seconds: int = Field(
        default=90,
        validation_alias="SPOONACULAR_RATE_LIMIT_COOLDOWN_SECONDS",
    )
    ...
    spoonacular_generation_enrichment_enabled: bool = Field(
        default=True,
        validation_alias="SPOONACULAR_GENERATION_ENRICHMENT_ENABLED",
    )
