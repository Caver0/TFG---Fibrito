...
FAMILY_DEFINITIONS: tuple[FoodFamilyDefinition, ...] = (
    ...
    FoodFamilyDefinition(
        ...
        roles=frozenset({"protein", "dairy"}),
        functional_groups=frozenset({"protein", "dairy"}),
        codes=frozenset({"skyr"}),
        tokens=("skyr",),
        priority=11,
    ),
    FoodFamilyDefinition(
        id="cottage_cheese_protein",
        roles=frozenset({"protein", "dairy"}),
        functional_groups=frozenset({"protein", "dairy"}),
        codes=frozenset({"cottage_cheese"}),
        tokens=("queso fresco batido", "cottage", "queso fresco", "quark"),
        priority=12,
    ),
    FoodFamilyDefinition(
        id="egg_proteins",
    ...
    FoodFamilyDefinition(
        ...
        roles=frozenset({"protein"}),
        functional_groups=frozenset({"protein"}),
        codes=frozenset({"lean_beef"}),
        tokens=("lean beef", "ternera magra", "beef", "ternera"),
        priority=24,
    ),
    FoodFamilyDefinition(
        id="toast_breads",
    ...
    FoodFamilyDefinition(
        ...
        roles=frozenset({"carb"}),
        functional_groups=frozenset({"carb"}),
        codes=frozenset({"whole_grain_bagel"}),
        tokens=("bagel",),
        priority=31,
    ),
    FoodFamilyDefinition(
        ...
        roles=frozenset({"carb"}),
        functional_groups=frozenset({"carb"}),
        codes=frozenset({"whole_wheat_wrap"}),
        tokens=("wrap", "tortilla integral", "whole wheat wrap"),
        priority=32,
    ),
    FoodFamilyDefinition(
        id="oats_cereals",
    ...
    FoodFamilyDefinition(
        id="cornflakes_cereals",
        roles=frozenset({"carb"}),
        functional_groups=frozenset({"carb"}),
        codes=frozenset({"cornflakes"}),
        tokens=("cornflakes", "copos de maiz", "flakes"),
        priority=34,
    ),
    FoodFamilyDefinition(
        id="granola_cereals",
    ...
    FoodFamilyDefinition(
        ...
        roles=frozenset({"carb"}),
        functional_groups=frozenset({"carb"}),
        codes=frozenset({"muesli"}),
        tokens=("muesli",),
        priority=36,
    ),
    FoodFamilyDefinition(
        id="rice_cake_starches",
        roles=frozenset({"carb"}),
        functional_groups=frozenset({"carb"}),
        codes=frozenset({"rice_cakes"}),
        tokens=("rice cake", "rice cakes", "tortitas de arroz"),
        priority=37,
    ),
    FoodFamilyDefinition(
        id="rice_starches",
    ...
    FoodFamilyDefinition(
        ...
        tokens=("potato", "patata"),
        priority=40,
    ),
    FoodFamilyDefinition(
        id="sweet_potato_starches",
        roles=frozenset({"carb"}),
        functional_groups=frozenset({"carb"}),
        codes=frozenset({"sweet_potato"}),
        tokens=("sweet potato", "boniato", "batata"),
        priority=41,
    ),
    FoodFamilyDefinition(
        id="banana_fruit",
    ...
    FoodFamilyDefinition(
        ...
        roles=frozenset({"carb", "fruit"}),
        functional_groups=frozenset({"fruit", "carb"}),
        codes=frozenset({"apple"}),
        tokens=("apple", "manzana"),
        priority=43,
    ),
    FoodFamilyDefinition(
        id="berries_fruit",
        roles=frozenset({"carb", "fruit"}),
        functional_groups=frozenset({"fruit", "carb"}),
        codes=frozenset({"berries"}),
        tokens=("berries", "frutos rojos", "berry"),
        priority=44,
    ),
    FoodFamilyDefinition(
        id="cooking_fats",
    ...
    FoodFamilyDefinition(
        ...
        tokens=("nuts", "frutos secos", "almendra", "walnut"),
        priority=52,
    ),
    FoodFamilyDefinition(
        id="peanut_butter_fats",
        roles=frozenset({"fat"}),
        functional_groups=frozenset({"fat"}),
        codes=frozenset({"peanut_butter"}),
        tokens=("peanut butter", "crema de cacahuete", "mantequilla de cacahuete"),
        priority=53,
    ),
    FoodFamilyDefinition(
        id="vegetable_sides",
        ...
        tokens=("verdura", "vegetable", "vegetables", "tomate", "brocoli"),
        priority=60,
    ),
    FoodFamilyDefinition(
        id="salad_vegetables",
        roles=frozenset({"vegetable"}),
        functional_groups=frozenset({"vegetable"}),
        codes=frozenset({"salad_mix"}),
        tokens=("ensalada", "salad", "lechuga", "mezcla de ensalada"),
        priority=61,
    ),
    FoodFamilyDefinition(
        id="dairy_supports",
        ...
        codes=frozenset({"semi_skimmed_milk", "greek_yogurt", "skyr", "cottage_cheese"}),
        tokens=("milk", "leche", "yogur", "yogurt", "skyr", "cottage"),
        priority=70,
    ),
)
