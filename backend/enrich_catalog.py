...
TARGETS = [
    # ── Carbohidratos ──────────────────────────────────────────────────────────
    ("white rice raw",              "carbohidratos"),
    ("brown rice raw",              "carbohidratos"),
    ("dry pasta",                   "carbohidratos"),
    ("whole wheat pasta dry",       "carbohidratos"),
    ("quinoa raw",                  "carbohidratos"),
    ("rolled oats",                 "carbohidratos"),
    ("sweet potato raw",            "carbohidratos"),
    ("corn tortilla",               "carbohidratos"),
    ("whole wheat bread",           "carbohidratos"),
    ("lentils dry",                 "carbohidratos"),
    ("chickpeas dry",               "carbohidratos"),
    ("black beans dry",             "carbohidratos"),
    ("kidney beans dry",            "carbohidratos"),
    ("white potato raw",            "carbohidratos"),
    ("couscous dry",                "carbohidratos"),
    ("bulgur dry",                  "carbohidratos"),
    ("buckwheat raw",               "carbohidratos"),
    ("millet raw",                  "carbohidratos"),
    ("cornmeal dry",                "carbohidratos"),
    ...
    # ── Proteínas magras ──────────────────────────────────────────────────────
    ("chicken breast raw",          "proteinas"),
    ("turkey breast raw",           "proteinas"),
    ("tuna in water canned",        "proteinas"),
    ("salmon raw",                  "proteinas"),
    ("cod raw",                     "proteinas"),
    ("tilapia raw",                 "proteinas"),
    ("shrimp raw",                  "proteinas"),
    ("egg whole raw",               "proteinas"),
    ("egg whites raw",              "proteinas"),
    ("tofu firm",                   "proteinas"),
    ("edamame raw",                 "proteinas"),
    ("tempeh",                      "proteinas"),
    ("seitan",                      "proteinas"),
    ("lean ground beef raw",        "proteinas"),
    ("pork tenderloin raw",         "proteinas"),
    ...
    ("tahini",                      "grasas"),
    # ── Verduras ──────────────────────────────────────────────────────────────
    ("broccoli raw",                "vegetales"),
    ("spinach raw",                 "vegetales"),
    ("kale raw",                    "vegetales"),
    ("green beans raw",             "vegetales"),
    ("zucchini raw",                "vegetales"),
    ("bell pepper raw",             "vegetales"),
    ("cherry tomatoes",             "vegetales"),
    ("cucumber raw",                "vegetales"),
    ("carrot raw",                  "vegetales"),
    ("mushrooms raw",               "vegetales"),
    ("cauliflower raw",             "vegetales"),
    ("asparagus raw",               "vegetales"),
    ("brussels sprouts raw",        "vegetales"),
    ("eggplant raw",                "vegetales"),
    ("celery raw",                  "vegetales"),
    ("lettuce romaine",             "vegetales"),
    ("arugula raw",                 "vegetales"),
    ("leek raw",                    "vegetales"),
    ("onion raw",                   "vegetales"),
    ("artichoke raw",               "vegetales"),
    ("peas raw",                    "vegetales"),
    ("corn raw",                    "vegetales"),
    ("beet raw",                    "vegetales"),
    ("cabbage raw",                 "vegetales"),
    ("swiss chard raw",             "vegetales"),
]
